...
class _AsthmaControlTestPageState extends State<AsthmaControlTestPage> {
  ...
  final List<Map<String, dynamic>> _questions = [
    {
      'question':
          '1. In the past 4 weeks, how often did your asthma prevent you from getting as much done at work, school, or home?',
      'options': [
        'All of the time',
        'Most of the time',
        'Some of the time',
    ...
    {
      'question':
          '4. During the past 4 weeks, how often have you used your reliever medication?',
      'options': [
  ...
  void _saveTestResults() {
    ...
    FirebaseService().addACT(_selectedOptions).then((value) => Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => const ControlTestInfoPage(
                    showBackButton: true,
                  )),
        ));
  }
            ...
            children: [
              ...
              ElevatedButton.icon(
                style: ElevatedButton.styleFrom(
                  backgroundColor:
                      Style.primaryColor, // Use your style for buttons here.
