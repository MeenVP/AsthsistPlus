...
class CalendarPageTutorial extends StatelessWidget {
  const CalendarPageTutorial({super.key});
    ...
    child: AppBar(
        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
                children: [
                  const Image(image: AssetImage('assets/images/Calendarpage.png')),
                  Padding(
                            ...
                            child: Material(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) => const InfoPageTutorial()),
                                  );
                                },
                                child: Text(
                                  'Next',
